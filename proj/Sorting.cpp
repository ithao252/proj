...
string column = "Id,Title,Price,User_id,profileName,review/helpfulness,review/score,review/time,review/summary,review/text";
...
// Merge all sorted file into a other file CSV
